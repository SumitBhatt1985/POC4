...
class EquipmentMaster(models.Model):
    ...
    generic_id = models.CharField(max_length=50, null=True, blank=True)
    ...
    equipment_serial_no = models.CharField(max_length=100, null=True, blank=True)
    equipment_code = models.CharField(max_length=100, null=True, blank=True)
    equipment_model = models.CharField(max_length=100, null=True, blank=True)
    maintop_number = models.CharField(max_length=100, null=True, blank=True)
    acquiant_issued = models.CharField(max_length=100, null=True, blank=True)
    authority = models.CharField(max_length=100, null=True, blank=True)
    ilms_equipment_code = models.CharField(max_length=100, null=True, blank=True)
    total_fits = models.CharField(max_length=100, null=True, blank=True)
    ship_applicable = models.CharField(max_length=100, null=True, blank=True)
    location_on_board = models.CharField(max_length=255, null=True, blank=True)
    equipment_type = models.CharField(max_length=100, null=True, blank=True)
    ship_id = models.CharField(max_length=50, null=True, blank=True)
    removal_date = models.DateField(null=True, blank=True)
    description = models.TextField(null=True, blank=True)
    srar_equipment = models.CharField(max_length=100, null=True, blank=True)
    system = models.CharField(max_length=100, null=True, blank=True)
    sub_system = models.CharField(max_length=100, null=True, blank=True)
    assembly = models.CharField(max_length=100, null=True, blank=True)
    department_id = models.CharField(max_length=50, null=True, blank=True)
    obsolete = models.CharField(max_length=10, null=True, blank=True)
    is_active = models.SmallIntegerField(default=1)
    class Meta:
