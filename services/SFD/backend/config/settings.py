"""
Django settings for SFD backend service.
"""

# ...copied and adapted from master_svc settings.py...
...
MIDDLEWARE = [
    ...
    # Add SFD-specific middleware here if needed
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DATABASE_NAME', default='master_svc_db'),
        'USER': config('DATABASE_USER', default='postgres'),
        'PASSWORD': config('DATABASE_PASSWORD', default='password'),
        'HOST': config('DATABASE_HOST', default='localhost'),
        'PORT': config('DATABASE_PORT', default='5432', cast=int),
        'OPTIONS': {
            'application_name': 'django_sfd',
            'options': '-c search_path=sfd',
        },
        'CONN_MAX_AGE': 600,
