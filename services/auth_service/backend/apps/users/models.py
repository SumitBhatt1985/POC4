...
class UserDetails(models.Model):
    ...
    sso_user = models.CharField(max_length=1, validators=[binary_validator])
    H = models.CharField(max_length=1, validators=[binary_validator])
    L = models.CharField(max_length=1, validators=[binary_validator])
    E = models.CharField(max_length=1, validators=[binary_validator])
    X = models.CharField(max_length=1, validators=[binary_validator])
    status = models.CharField(max_length=1, validators=[binary_validator])
